...
module demo_chip (
   ...
   PADBID BS_ren_0_pad (
      .I  (BitStream_ram_ren_0_i),
      .OEN(1'b0),
      .PAD(BS_ren_0),
      .C  ()
   );
   PADBID BS_ren_1_pad (
      .I  (BitStream_ram_ren_1_i),
      .OEN(1'b0),
      .PAD(BS_ren_1),
      .C  ()
   );

   PADBID scan_mode_pad (
      .I  (1'b0),
      .OEN(1'b1),
      .PAD(scan_mode),
      .C  (scan_mode_i)
   ...
   PADCLK sysclk_byp_pad (
      .PAD(sysclk_byp),
      .C  (sysclk_byp_i)
   );
   PADCLK usbclk_byp_pad (
      .PAD(usbclk_byp),
      .C  (usbclk_byp_i)
   );
   ...
   generate
      for (i = 0; i <= 15; i = i + 1) begin
         PADBID BS_data_0_pad (
            .I  (1'b0),
            .OEN(1'b1),
            .PAD(BS_data_0[i]),
            .C  (BitStream_buffer_input_0_i[i])
         );
         PADBID BS_data_1_pad (
            .I  (1'b0),
            .OEN(1'b1),
            .PAD(BS_data_1[i]),
            .C  (BitStream_buffer_input_1_i[i])
         );
      end
   endgenerate
   ...
   generate
      for (i = 0; i <= 16; i = i + 1) begin
         PADBID BS_addr_0_pad (
            .I  (BitStream_ram_addr_0_i[i]),
            .OEN(1'b0),
            .PAD(BS_addr_0[i]),
            .C  ()
         );
         PADBID BS_addr_1_pad (
            .I  (BitStream_ram_addr_1_i[i]),
            .OEN(1'b0),
            .PAD(BS_addr_1[i]),
            .C  ()
         );
   ...
   PADBID i_usb_pad_plus (
      .I  (usb_txdp),
      .OEN(usb_txoe),
      .PAD(usb_plus),
      .C  (usb_rxdp)
   );
   PADBID i_usb_pad_minus (
      .I  (usb_txdn),
      .OEN(usb_txoe),
      .PAD(usb_minus),
      .C  (usb_rxdn)
   ...
   PADBID ddr0_cs_n_pad (
      .I  (ddr0_cs_n_i),
      .OEN(1'b0),
      .PAD(ddr0_cs_n),
      .C  ()
   );
   PADBID ddr0_we_n_pad (
      .I  (ddr0_we_n_i),
      .OEN(1'b0),
      .PAD(ddr0_we_n),
      .C  ()
   );
   PADBID ddr0_cas_n_pad (
      .I  (ddr0_cas_n_i),
      .OEN(1'b0),
      .PAD(ddr0_cas_n),
      .C  ()
   );
   PADBID ddr0_ras_n_pad (
      .I  (ddr0_ras_n_i),
      .OEN(1'b0),
      .PAD(ddr0_ras_n),
      .C  ()
   ...
   PADBID ddr1_cs_n_pad (
      .I  (ddr1_cs_n_i),
      .OEN(1'b0),
      .PAD(ddr1_cs_n),
      .C  ()
   );
   PADBID ddr1_we_n_pad (
      .I  (ddr1_we_n_i),
      .OEN(1'b0),
      .PAD(ddr1_we_n),
      .C  ()
   );
   PADBID ddr1_cas_n_pad (
      .I  (ddr1_cas_n_i),
      .OEN(1'b0),
      .PAD(ddr1_cas_n),
      .C  ()
   );
   PADBID ddr1_ras_n_pad (
      .I  (ddr1_ras_n_i),
      .OEN(1'b0),
      .PAD(ddr1_ras_n),
      .C  ()
   ...
   PADBID ddr2_cs_n_pad (
      .I  (ddr2_cs_n_i),
      .OEN(1'b0),
      .PAD(ddr2_cs_n),
      .C  ()
   );
   PADBID ddr2_we_n_pad (
      .I  (ddr2_we_n_i),
      .OEN(1'b0),
      .PAD(ddr2_we_n),
      .C  ()
   );
   PADBID ddr2_cas_n_pad (
      .I  (ddr2_cas_n_i),
      .OEN(1'b0),
      .PAD(ddr2_cas_n),
      .C  ()
   );
   PADBID ddr2_ras_n_pad (
      .I  (ddr2_ras_n_i),
      .OEN(1'b0),
      .PAD(ddr2_ras_n),
      .C  ()
   ...
   PADBID ddr3_cs_n_pad (
      .I  (ddr3_cs_n_i),
      .OEN(1'b0),
      .PAD(ddr3_cs_n),
      .C  ()
   );
   PADBID ddr3_we_n_pad (
      .I  (ddr3_we_n_i),
      .OEN(1'b0),
      .PAD(ddr3_we_n),
      .C  ()
   );
   PADBID ddr3_cas_n_pad (
      .I  (ddr3_cas_n_i),
      .OEN(1'b0),
      .PAD(ddr3_cas_n),
      .C  ()
   );
   PADBID ddr3_ras_n_pad (
      .I  (ddr3_ras_n_i),
      .OEN(1'b0),
      .PAD(ddr3_ras_n),
      .C  ()
   ...
   always @(posedge mclk_nova0) begin
      if (ext_frame_RAM0_cs_n == 1'b0)
         if (ext_frame_RAM0_wr) fml_sel_ddr0 <= dis_frame_RAM_din_0[7:0];
         else fml_sel_ddr0 <= dis_frame_RAM_din_0[15:8];
   end
   ...
   always @(posedge mclk_nova0) begin
      if (ext_frame_RAM1_cs_n == 1'b0)
         if (ext_frame_RAM1_wr) fml_sel_ddr1 <= dis_frame_RAM_din_0[23:16];
         else fml_sel_ddr1 <= dis_frame_RAM_din_0[31:24];
   end
   ...
   always @(posedge mclk_nova1) begin
      if (ext_frame_RAM2_cs_n == 1'b0)
         if (ext_frame_RAM0_wr) fml_sel_ddr2 <= dis_frame_RAM_din_1[7:0];
         else fml_sel_ddr2 <= dis_frame_RAM_din_1[15:8];
   end
   // Dummy register to expand DDR bus to 64 bits
   ...
   always @(posedge mclk_nova1) begin
      if (ext_frame_RAM3_cs_n == 1'b0)
         if (ext_frame_RAM0_wr) fml_sel_ddr3 <= dis_frame_RAM_din_1[23:16];
         else fml_sel_ddr3 <= dis_frame_RAM_din_1[31:24];
   end
